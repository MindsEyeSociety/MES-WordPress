 ...
 * @return array
 */
function mindseyesociety_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'mindseyesociety_page_menu_args' );
 ...
 * @return array
 */
function mindseyesociety_body_classes( $classes ) {
 ...
 * @return void
 */
function mindseyesociety_setup_author() {
	global $wp_query;
