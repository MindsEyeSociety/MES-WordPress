 ...
 */
function mindseyesociety_customize_register( $wp_customize ) {
...
function mindseyesociety_customize_preview_js() {
	wp_enqueue_script( 'mindseyesociety_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
